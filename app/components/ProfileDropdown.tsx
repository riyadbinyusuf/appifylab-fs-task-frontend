      ...
      <div className="_header_nav_profile">
        <div className="_header_nav_dropdown">
          <button
            ...
            className="_header_nav_dropdown_btn _dropdown_toggle d-flex justify-content-between align-items-center column-gap-3"
            type="button"
          >
            <div className="d-flex align-items-center justify-content-start column-gap-1">
          ...
          <ul className="_nav_dropdown_list">
            ...
            <li className="_nav_dropdown_list_item">
              <button
                ...
                type="button"
                className="_nav_dropdown_link w-100 _nav_drop_btn_link"
              >
                <div className="_nav_drop_info">
                  <span>
                    <svg
